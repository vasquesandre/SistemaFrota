            ...
            if (response.length > 0) {
                $.each(response, function (index, veiculo) {
                    var linha = '<tr>' +
                        ...
                        '<a class="dropdown-item" href="javascript:void(0);" onclick="confirmarDesativarVeiculo(\'' + veiculo.placa + '\', \'' + veiculo.modelo + '\')"><i class="bx bx-user-x me-1"></i>Desativar</a>' +
                        '</div>' +
                        '</div>' +
                        '</td>' +
                        '</tr>';
